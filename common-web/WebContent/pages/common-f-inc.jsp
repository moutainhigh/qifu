...
<link rel="stylesheet" href="<%=mainBasePath%>/bootstrap-4.0.0-alpha.6/css/bootstrap.css?ver=${jsVerBuild}" crossorigin="anonymous">
<link href="<%=mainBasePath%>/font-awesome/css/font-awesome.min.css?ver=${jsVerBuild}" rel="stylesheet" type="text/css" />
<script src="<%=mainBasePath%>/bootstrap-4.0.0-alpha.6/js/bootstrap.js?ver=${jsVerBuild}" crossorigin="anonymous"></script>
